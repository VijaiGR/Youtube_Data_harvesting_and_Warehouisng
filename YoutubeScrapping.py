...
with tab1:
    ...
    # Create some space below the input field
...
# ----------------------------------------------------------------------------------------------------- #
        ...
        client = MongoClient(
            f"mongodb+srv://vijaigowtham11:{atlas_password}@cluster11.tdzyngu.mongodb.net/?retryWrites=true&w=majority")
...
with tab2:
    ...
    database='youtube_db'
        ...
        if question_tosql == '1. What are the names of all the videos and their corresponding channels?':
            # cursor.execute(
            #     "SELECT channel.Channel_Name, video.Video_Name FROM channel  JOIN video ON channel.Channel_Id = playlist.Channel_Id AND playlist.Playlist_Id = video.Playlist_Id;")
            cursor.execute(
                'SELECT "channel"."Channel_Name", "video"."Video_Name", "playlist"."Playlist_Id" '
                'FROM "playlist" '
        ...
        # Q3
            ...
            cursor.execute('SELECT "channel"."Channel_Name", "video"."Video_Name", "video"."View_Count" '
                           'FROM "channel" '
        ...
        # Q8
            ...
            cursor.execute('SELECT "channel"."Channel_Name", "video"."Video_Name", "video"."Published_date" '
                           'FROM "channel" '
                           'JOIN "playlist" ON "channel"."Channel_Id" = "playlist"."Channel_Id" '
                           'JOIN "video" ON "playlist"."Playlist_Id" = "video"."Playlist_Id" '
